...
export function ResponsiveDesign(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="60px"
      height="60px"
    ...
    >
      ...
      />
      <path
        d="M512 844.8m-38.4 0a38.4 38.4 0 1 0 76.8 0 38.4 38.4 0 1 0-76.8 0Z"
        fill="#D4594C"
      />
      <path
        d="M512 896c-28.16 0-51.2-23.04-51.2-51.2s23.04-51.2 51.2-51.2 51.2 23.04 51.2 51.2-23.04 51.2-51.2 51.2z m0-76.8c-14.08 0-25.6 11.52-25.6 25.6s11.52 25.6 25.6 25.6 25.6-11.52 25.6-25.6-11.52-25.6-25.6-25.6z"
        fill="#231C1C"
      />
